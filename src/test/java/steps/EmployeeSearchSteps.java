...
public class EmployeeSearchSteps extends CommonMethods {
    ...
    public void user_enters_valid_employee_id() {
       ...
       //searchIdTextBox.sendKeys("54477A");
        sendText("54477A", employeeSearchPage.searchIdTextBox);
    }
    ...
    public void user_is_able_to_see_employee_information() {
        System.out.println("Employee is display");
    }
    ...
    public void user_enters_valid_employee_name_in_name_text_box() {
        ...
        sendText("selab", employeeSearchPage.empNameField);
    }
