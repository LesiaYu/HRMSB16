...
String empId;
    ...
    public void user_clicks_on_add_employee_button() {
       //WebElement addEmployButton= driver.findElement(By.id("menu_pim_addEmployee"));
       // addEmployButton.click();
    ...
    public void user_enters_firstname_and_lastname() {
       ...
       //firstNameTextField.sendKeys("Aendro");
        sendText("Aendro", addEmployeePage.firstNameTextField);

        //WebElement lastNameTextField=driver.findElement(By.id("lastName"));
       // lastNameTextField.sendKeys("Farewell");
        sendText("Farewell", addEmployeePage.lastNameTextField);
    }
    @When("user clicks on save button")
    public void   buser_clicks_on_save_button() {
    ...
    @When("users enters {string} and {string} and {string} in data driven format")
    public void users_enters_and_and_in_data_driven_format(String firstName, String middleName, String lastName) {
        sendText(firstName, addEmployeePage.firstNameTextField);
        sendText(middleName, addEmployeePage.middleNameField);
        sendText(lastName, addEmployeePage.lastNameTextField);
    }
    ...
    public void user_enters_adds_multiple_employees_using_excel_from_and_verify_it (String sheetName) throws InterruptedException {
        ...
        while (itr.hasNext()){
            ...
            for (int i=0; i<rowData.size(); i++){
                ...
                //output of this will be empid firstname middle name lastname
